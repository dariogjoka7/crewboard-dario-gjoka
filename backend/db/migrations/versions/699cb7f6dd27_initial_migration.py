...
Revision ID: 699cb7f6dd27
Revises: 
Create Date: 2026-02-21 21:47:31.871472
...
def upgrade() -> None:
    ...
    op.create_table('crew_members',
        ...
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('email', name='uq_crew_member_email'),
    ...
    op.create_table('crew_member_flight_assignments',
        sa.Column('crew_member_id', sa.Integer(), nullable=True),
...
def downgrade() -> None:
    op.drop_table('crew_member_flight_assignments')
