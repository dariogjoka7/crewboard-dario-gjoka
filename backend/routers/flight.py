...
@router.get(
    path='/',
    description='For listing flights',
    response_model=BaseListResponse[FlightResponse],
    responses={
        status.HTTP_400_BAD_REQUEST: {'model': BaseMessageResponse, 'description': 'Failed to list flights'},
        status.HTTP_500_INTERNAL_SERVER_ERROR: {'model': BaseMessageResponse, 'description': 'Internal server error'}
    }
)
...
@router.get(
    ...
    responses={
        status.HTTP_400_BAD_REQUEST: {'model': BaseMessageResponse, 'description': 'Failed to get one flight'},
        status.HTTP_500_INTERNAL_SERVER_ERROR: {'model': BaseMessageResponse, 'description': 'Internal server error'}
    }
)
